...
import com.latihan.uas_10118320_if8.maps.MapsWisata3Activity;
import com.latihan.uas_10118320_if8.maps.MapsWisata4Activity;
import com.latihan.uas_10118320_if8.model.Wisata3;
...
public class Wisata4Adapter extends RecyclerView.Adapter<Wisata4Adapter.ViewHolder> {
    ...
    public Wisata4Adapter(Context context, ArrayList<Wisata4> wisata4s){
        ...
        ref = FirebaseDatabase.getInstance("https://uas-akb-10118311-default-rtdb.asia-southeast1.firebasedatabase.app")
