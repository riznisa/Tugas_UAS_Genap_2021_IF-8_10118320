package com.latihan.uas_10118320_if8.model;
...
public class Wisata1 {
    ...
    public Wisata1(String nama_tempat, String alamat_tempat, String biaya_masuk, String gambar_tempat, Double latitude, Double longitude){
        this.nama_tempat = nama_tempat;
        this.alamat_tempat = alamat_tempat;
        this.biaya_masuk = biaya_masuk;
        this.gambar_tempat = gambar_tempat;
